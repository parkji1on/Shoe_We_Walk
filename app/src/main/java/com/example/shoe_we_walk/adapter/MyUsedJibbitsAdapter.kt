...
import com.example.shoe_we_walk.dialog.JibbitsUnsetDialog

class MyUsedJibbitsAdapter (private val context : Context): RecyclerView.Adapter<MyUsedJibbitsAdapter.ViewHolder>(), JibbitsUnsetDialog.MyUnsetDialogListener {
    ...
    inner class ViewHolder(view : View) :RecyclerView.ViewHolder(view){
        ...
        fun bind(item :MyUsedJibbitsData)
        {
            ...
            itemView.setOnClickListener {
                AP = adapterPosition
                val dialog = JibbitsUnsetDialog(context, item)
                dialog.setDialogListener(this@MyUsedJibbitsAdapter)
                dialog.showDialog()
            }
        }
    }
